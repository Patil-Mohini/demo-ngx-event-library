(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ng2-semantic-ui-v9', ['exports', '@angular/core', 'extend', '@angular/common', '@angular/forms', 'popper.js', 'date-fns', 'date-fns/locale/en-US', 'bowser', 'is-ua-webview', 'element-closest'], factory) :
    (global = global || self, factory(global['ng2-semantic-ui-v9'] = {}, global.ng.core, global.$extend__default, global.ng.common, global.ng.forms, global.Popper, global.dateFns, global.defaultLocale, global.bowser, global.isUAWebView__default));
    ...
    ***************************************************************************** */
    ...
    var SuiTransition = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.transition")
    ...
    var SuiPagination = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.ui"),
            core.HostBinding("class.pagination"),
            core.HostBinding("class.menu")
    ...
    var SuiAccordion = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.ui"),
            core.HostBinding("class.accordion")
        ...
        __decorate([
            core.ContentChildren(SuiAccordionPanel, { descendants: true })
    ...
    var SuiCollapse = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.collapsed")
        ], SuiCollapse.prototype, "isCollapsed", null);
        __decorate([
            core.HostBinding("class.collapsing")
    ...
    var DateUtil = {
        startOf: function (precision, date, resetAll) {
            ...
            switch (precision) {
                ...
                // falls through
                case exports.ɵbw.Year:
                    date.setMonth(0);
                    if (!resetAll) {
                        break;
                    }
                // falls through
                case exports.ɵbw.Month:
                    date.setDate(1);
                    if (!resetAll) {
                        break;
                    }
                // falls through
                case exports.ɵbw.Date:
                    date.setHours(0);
                    if (!resetAll) {
                        break;
                    }
                // falls through
                case exports.ɵbw.Hour:
                    date.setMinutes(0);
                    if (!resetAll) {
                        break;
                    }
                // falls through
                case exports.ɵbw.Minute:
                    date.setSeconds(0, 0);
            }
            return date;
        },
    ...
    var SuiCheckbox = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.read-only"),
            core.Input()
    ...
    var SuiRadio = /** @class */ (function () {
        ...
        __decorate([
            core.Output("currentValueChange")
    ...
    var SuiRadioManager = /** @class */ (function () {
        ...
        __decorate([
            core.ContentChildren(SuiRadioManager_1, { descendants: true })
        ], SuiRadioManager.prototype, "_subManagers", void 0);
        __decorate([
            core.ContentChildren(SuiRadio, { descendants: true })
    ...
    var CalendarView = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChildren(SuiCalendarItem)
    ...
    var CalendarConfig = /** @class */ (function () {
        ...
        CalendarConfig.prototype.updateBounds = function (providedDate) {
            this.dateMinBound = DateUtil.startOf(exports.ɵbw.Year, new Date(), true);
    ...
    var YearConfig = /** @class */ (function (_super) {
        ...
        function YearConfig() {
            return _super.call(this, exports.ɵbw.Year, new YearMappings(), "number") || this;
        }
        return YearConfig;
    }(DateConfigBase));
    var MonthConfig = /** @class */ (function (_super) {
        ...
        function MonthConfig() {
            return _super.call(this, exports.ɵbw.Month, new MonthMappings(), "month") || this;
        }
        return MonthConfig;
    }(DateConfigBase));
    var DateConfig = /** @class */ (function (_super) {
        ...
        function DateConfig() {
            return _super.call(this, exports.ɵbw.Date, new DateMappings(), "date") || this;
        }
        return DateConfig;
    }(DateConfigBase));
    var DatetimeConfig = /** @class */ (function (_super) {
        ...
        function DatetimeConfig() {
            return _super.call(this, CalendarMode.Both, exports.ɵbw.Minute, new DatetimeMappings(), "datetime-local") || this;
        }
    ...
    var TimeConfig = /** @class */ (function (_super) {
        ...
        function TimeConfig() {
            return _super.call(this, CalendarMode.TimeOnly, exports.ɵbw.Minute, new TimeMappings(), "time") || this;
        }
        TimeConfig.prototype.updateBounds = function (providedDate) {
            this.dateMaxBound = DateUtil.endOf(exports.ɵbw.Date, DateUtil.clone(providedDate));
            this.dateMinBound = DateUtil.previous(exports.ɵbw.Date, DateUtil.clone(this.dateMaxBound));
        };
        return TimeConfig;
    }(CalendarConfig));
    ...
    var DateComparer = /** @class */ (function () {
        ...
        DateComparer.prototype.equal = function (a, b) {
            if (this._precision === exports.ɵbw.Minute) {
                return !!b &&
                    DateUtil.equal(exports.ɵbw.Hour, b, a) &&
    ...
    var SuiDatepicker = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.ui"),
            core.HostBinding("class.active"),
            core.HostBinding("class.calendar")
    ...
    var SuiPopup = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild("templateSibling", { read: core.ViewContainerRef, static: true })
    ...
    var SuiPopupArrow = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.inverted"),
            core.Input()
    ...
    var SuiDatepickerInputDirective = /** @class */ (function () {
        ...
        __decorate([
            core.Input("pickerUseNativeOnMobile")
        ...
        __decorate([
            core.HostBinding("attr.max")
        ], SuiDatepickerInputDirective.prototype, "max", null);
        __decorate([
            core.HostBinding("attr.min")
    ...
    var CalendarRangeDateService = /** @class */ (function (_super) {
        ...
        CalendarRangeDateService.prototype.calcStart = function (start) {
            var monthStart = DateUtil.startOf(exports.ɵbw.Month, DateUtil.clone(start));
    ...
    var SuiCalendarDateView = /** @class */ (function (_super) {
        ...
        function SuiCalendarDateView(renderer) {
            return _super.call(this, renderer, CalendarViewType.Date, new CalendarRangeDateService(exports.ɵbw.Month, 6, 7)) || this;
        }
    ...
    var SuiCalendarHourView = /** @class */ (function (_super) {
        ...
        function SuiCalendarHourView(renderer) {
            return _super.call(this, renderer, CalendarViewType.Hour, new CalendarRangeHourService(exports.ɵbw.Date, 6, 4)) || this;
        }
    ...
    var CalendarRangeMinuteService = /** @class */ (function (_super) {
        ...
        CalendarRangeMinuteService.prototype.calcStart = function (start) {
            return DateUtil.startOf(exports.ɵbw.Hour, DateUtil.clone(start), true);
        };
        CalendarRangeMinuteService.prototype.calcDates = function (start) {
            return Util.Array
                .range(this.length)
                .map(function (i) { return DateUtil.add(exports.ɵbw.Minute, DateUtil.clone(start), i * 5); });
        };
    ...
    var SuiCalendarMinuteView = /** @class */ (function (_super) {
        ...
        function SuiCalendarMinuteView(renderer) {
            return _super.call(this, renderer, CalendarViewType.Minute, new CalendarRangeMinuteService(exports.ɵbw.Hour, 4, 3)) || this;
        }
    ...
    var SuiCalendarMonthView = /** @class */ (function (_super) {
        ...
        function SuiCalendarMonthView(renderer) {
            return _super.call(this, renderer, CalendarViewType.Month, new CalendarRangeMonthService(exports.ɵbw.Year, 4, 3)) || this;
        }
    ...
    var SuiCalendarYearView = /** @class */ (function (_super) {
        ...
        function SuiCalendarYearView(renderer) {
            return _super.call(this, renderer, CalendarViewType.Year, new CalendarRangeYearService(exports.ɵbw.Decade, 4, 3)) || this;
        }
        Object.defineProperty(SuiCalendarYearView.prototype, "decadeStart", {
            get: function () {
                return DateUtil
                    .startOf(exports.ɵbw.Decade, DateUtil.clone(this.service.currentDate))
                    .getFullYear();
            },
            enumerable: true,
            configurable: true
    ...
    var SuiDropdownMenuItem = /** @class */ (function () {
        ...
        __decorate([
            core.ContentChild(core.forwardRef(function () { return SuiDropdownMenu; }))
    ...
    var SuiDropdownMenu = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ContentChildren(SuiDropdownMenuItem, { descendants: true })
    ...
    var SuiDropdown = /** @class */ (function () {
        ...
        __decorate([
            core.ContentChild(SuiDropdownMenu)
        ], SuiDropdown.prototype, "_menu", void 0);
        __decorate([
            core.ContentChildren(SuiDropdown_1, { descendants: true })
    ...
    var SuiModalDimmer = /** @class */ (function (_super) {
        ...
        __decorate([
            core.HostBinding("class.page"),
            core.HostBinding("class.modals")
    ...
    var SuiProgress = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("attr.data-percent")
    ...
    var SuiSearch = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild(SuiDropdownMenu, { static: true })
        ], SuiSearch.prototype, "_menu", void 0);
        __decorate([
            core.HostBinding("class.ui"),
            core.HostBinding("class.search")
    ...
    var SuiSelectBase = /** @class */ (function () {
        ...
        SuiSelectBase.prototype.onAvailableOptionsRendered = function () {
            ...
            setTimeout(function () { return _this._renderedOptions.forEach(function (ro) { return _this.initialiseRenderedOption(ro); }); });
        ...
        __decorate([
            core.ContentChildren(SuiSelectOption, { descendants: true })
        ], SuiSelectBase.prototype, "_renderedOptions", void 0);
        __decorate([
            core.HostBinding("class.ui"),
            core.HostBinding("class.dropdown")
        ...
        __decorate([
            core.ViewChild(SuiSelectSearch, { static: true })
        ], SuiSelectBase.prototype, "_internalSearch", void 0);
        __decorate([
            core.ContentChild(SuiSelectSearch)
    ...
    var SuiSelect = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild("optionTemplateSibling", { read: core.ViewContainerRef, static: true })
    ...
    var SuiSidebar = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.animating")
    ...
    var SuiSidebarSibling = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.dimmed")
        ], SuiSidebarSibling.prototype, "isDimmed", null);
        __decorate([
            core.HostBinding("class.pusher")
    ...
    var SuiSidebarContainer = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.pushable")
        ], SuiSidebarContainer.prototype, "hasClasses", void 0);
        __decorate([
            core.ContentChild(SuiSidebar)
        ], SuiSidebarContainer.prototype, "sidebar", void 0);
        __decorate([
            core.ContentChild(SuiSidebarSibling)
    ...
    var SuiTabContent = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding("class.tab")
        ], SuiTabContent.prototype, "hasClasses", void 0);
        __decorate([
            core.Input("suiTabContent")
    ...
    var SuiTabset = /** @class */ (function () {
        ...
        __decorate([
            core.ContentChildren(SuiTabHeader, { descendants: true })
        ], SuiTabset.prototype, "_tabHeaders", void 0);
        __decorate([
            core.ContentChildren(SuiTabContent, { descendants: true })
...
//# sourceMappingURL=ng2-semantic-ui-v9.umd.js.map
